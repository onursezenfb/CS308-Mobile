...
struct PremiumView: View {
    ...
    var body: some View {
        VStack {
            // Greeting and Title
            Text("Hello, \(userSession.name ?? "User")! Tailor Your Tunes to Perfection with Music Tailor Premium!")
                .font(.title)
                .bold()
            ...
            .padding(.horizontal, 50) // Adjust the horizontal padding if needed
        }
    }
